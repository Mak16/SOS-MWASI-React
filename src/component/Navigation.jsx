    ...
    <>
      <nav className="flex  justify-between items-center bg-white py-[10px] px-[36px] text-sm ">
        ...
        <div onClick={()=>setIsOpen(!isOpen)} className="">
          {
            isOpen?<Icon className="text-[#0096F5] block sm:hidden text-[2rem] sm:text-[46px]" icon="line-md:menu-to-close-alt-transition"/>:
            <Icon className="text-[#0096F5] block sm:hidden text-[2rem] sm:text-[46px]" icon="mdi-light:menu"/>
          }
        </div>
